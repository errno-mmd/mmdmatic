...
mkdir data || goto die
cd data || goto die
curl -sc cookie "https://drive.google.com/uc?id=1dr1LKWEA3L6cuSeljS5h-tzPqc0jyOAR&export=download" > log.txt || goto die
...
set MSG2="&id=1dr1LKWEA3L6cuSeljS5h-tzPqc0jyOAR"
