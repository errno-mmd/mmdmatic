...
class AutoTraceFrame(wx.Frame):
    ...
    def __init__(self, *args, **kw):
        ...
        self.txt_input_video = wx.TextCtrl(panel, wx.ID_ANY, size=(500, -1))
        self.button_selectfile = wx.Button(panel, wx.ID_ANY, 'Select')
        self.button_selectfile.Bind(wx.EVT_BUTTON, self.click_selectfile)
        self.label_maxpeople = wx.StaticText(panel, wx.ID_ANY, 'maximum number of people')
        ...
        self.txt_reversespec = wx.TextCtrl(panel, wx.ID_ANY, size=(500, -1))
        self.label_orderspec = wx.StaticText(panel, wx.ID_ANY, 'order_specific')
        self.txt_orderspec = wx.TextCtrl(panel, wx.ID_ANY, size=(500, -1))
        self.label_loglevel = wx.StaticText(panel, wx.ID_ANY, 'verbosity')
        self.spin_loglevel = wx.SpinCtrl(panel, wx.ID_ANY, "", min=1, max=3, initial=2)
        ...
        hsizer1.Add(self.label_selectfile, 0, wx.ALL, 5)
        hsizer1.Add(self.txt_input_video, 0, wx.ALL, 5)
        hsizer1.Add(self.button_selectfile, 0, wx.ALL, 5)

        gsizer1 = wx.FlexGridSizer(2, 2, 2)
        gsizer1.Add(self.label_maxpeople, 0, wx.ALL | wx.ALIGN_CENTER_VERTICAL, 5)
        gsizer1.Add(self.spin_maxpeople, 0, wx.ALL | wx.ALIGN_CENTER_VERTICAL, 5)
        gsizer1.Add(self.label_firstframe, 0, wx.ALL | wx.ALIGN_CENTER_VERTICAL, 5)
        gsizer1.Add(self.spin_firstframe, 0, wx.ALL | wx.ALIGN_CENTER_VERTICAL, 5)
        gsizer1.Add(self.label_lastframe, 0, wx.ALL | wx.ALIGN_CENTER_VERTICAL, 5)
        gsizer1.Add(self.spin_lastframe, 0, wx.ALL | wx.ALIGN_CENTER_VERTICAL, 5)
        gsizer1.Add(self.label_reversespec, 0, wx.ALL | wx.ALIGN_CENTER_VERTICAL, 5)
        gsizer1.Add(self.txt_reversespec, 0, wx.ALL | wx.ALIGN_CENTER_VERTICAL, 5)
        gsizer1.Add(self.label_orderspec, 0, wx.ALL | wx.ALIGN_CENTER_VERTICAL, 5)
        gsizer1.Add(self.txt_orderspec, 0, wx.ALL | wx.ALIGN_CENTER_VERTICAL, 5)
        gsizer1.Add(self.label_loglevel, 0, wx.ALL | wx.ALIGN_CENTER_VERTICAL, 5)
        gsizer1.Add(self.spin_loglevel, 0, wx.ALL | wx.ALIGN_CENTER_VERTICAL, 5)

        sizer = wx.BoxSizer(wx.VERTICAL)
        sizer.Add(hsizer1, 0, wx.ALL)
        sizer.Add(gsizer1, 0, wx.ALL)
...
#        sys.stdout = sys.stderr = self.txt_output
    ...
    def click_run(self, event):
        ...
        thread = Thread(target=self.run_trace, args=(str(video_file), ))
    ...
    def run_trace(self, video_file):
        ...
        if not 'output_dir' in conf:
            conf['output_dir'] = ''
        conf['log_level'] = self.spin_loglevel.GetValue()
